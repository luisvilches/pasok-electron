...
let getPublishConfigs = exports.getPublishConfigs = (() => {
    var _ref3 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (packager, targetSpecificOptions, arch) {
        let publishers;
    ...
    return function getPublishConfigs(_x5, _x6, _x7) {
        return _ref3.apply(this, arguments);
    };
})();

let getResolvedPublishConfig = (() => {
    var _ref4 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (packager, options, arch) {
        let getInfo = (() => {
    ...
    return function getResolvedPublishConfig(_x8, _x9, _x10) {
    ...
    artifactCreated(event) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            if (target != null && eventFile != null && !_this.cancellationToken.cancelled) {
                if (packager.platform === (_index || _load_index()).Platform.MAC && target.name === "zip" || packager.platform === (_index || _load_index()).Platform.WINDOWS && isSuitableWindowsTarget(target, event)) {
                    _this.taskManager.addTask((0, (_updateUnfoBuilder || _load_updateUnfoBuilder()).writeUpdateInfo)(event, publishConfigs).then(function (it) {
                        var _postponedArtifactCre;

                        return (_postponedArtifactCre = _this.postponedArtifactCreatedEvents).push.apply(_postponedArtifactCre, _toConsumableArray(it));
                    }));
                }
            }
        })();
